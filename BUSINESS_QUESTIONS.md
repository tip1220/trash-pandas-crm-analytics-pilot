...
A valuable no-show recovery target is someone who:
...
- group tickets purchased
- group revenue
- scan rate
- repeat group activity
- organization type
- renewal timing
- engagement
...
A theme-night buyer may become a valuable follow-up target if they:

- attend multiple related theme nights
- buy merch tied to the theme
- bring family or group members
- scan reliably
...
This question helps uncover hidden high-value fans that ticket-only reporting may miss.
...
- send no-show recovery offer
- invite to next theme night
- offer family pack
- assign group sales call
- invite to mini-plan offer
- send merch discount
- add to renewal campaign
- monitor only
